          ...
          <PageContainer>
            <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem', textAlign: 'center' }}>
              <div style={{ marginBottom: '3rem' }}>
                ...
                <h2 style={{ fontSize: '2rem', fontWeight: '700', color: '#333', margin: '0 0 0.5rem 0' }}>개인 프로필</h2>
                <p style={{ fontSize: '1.1rem', color: '#666', margin: '0' }}>개인화된 학습 경험과 진도 추적</p>
              </div>
              ...
              <div style={{ display: 'grid', gap: '2rem', marginBottom: '3rem', textAlign: 'left' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem', padding: '1.5rem', background: '#f8f9fa', borderRadius: '12px', border: '1px solid #e9ecef' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <h3 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#333', margin: '0 0 0.5rem 0' }}>학습 통계</h3>
                    <p style={{ fontSize: '0.95rem', color: '#666', margin: '0', lineHeight: '1.5' }}>저장한 단어 수, 읽은 기사 수, 학습 연속일 등 개인 학습 기록을 확인할 수 있습니다</p>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem', padding: '1.5rem', background: '#f8f9fa', borderRadius: '12px', border: '1px solid #e9ecef' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <h3 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#333', margin: '0 0 0.5rem 0' }}>개인 설정</h3>
                    <p style={{ fontSize: '0.95rem', color: '#666', margin: '0', lineHeight: '1.5' }}>번역 언어, TTS 속도, 자동 저장 등 개인 맞춤 설정을 관리할 수 있습니다</p>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem', padding: '1.5rem', background: '#f8f9fa', borderRadius: '12px', border: '1px solid #e9ecef' }}>
                  <div style={{ fontSize: '2rem', flexShrink: 0 }}>🏆</div>
                  <div style={{ flex: 1 }}>
                    <h3 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#333', margin: '0 0 0.5rem 0' }}>학습 레벨</h3>
                    <p style={{ fontSize: '0.95rem', color: '#666', margin: '0', lineHeight: '1.5' }}>학습 활동에 따라 레벨이 상승하며, 성취 배지와 함께 동기부여를 제공합니다</p>
                  </div>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem', padding: '1.5rem', background: '#f8f9fa', borderRadius: '12px', border: '1px solid #e9ecef' }}>
                  <div style={{ fontSize: '2rem', flexShrink: 0 }}>📈</div>
                  <div style={{ flex: 1 }}>
                    <h3 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#333', margin: '0 0 0.5rem 0' }}>최근 활동</h3>
                    <p style={{ fontSize: '0.95rem', color: '#666', margin: '0', lineHeight: '1.5' }}>최근 저장한 단어, 좋아요한 기사 등 학습 활동 기록을 쉽게 확인할 수 있습니다</p>
                  </div>
                </div>
              </div>
              ...
              <div style={{ padding: '2rem', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', borderRadius: '16px', color: 'white', textAlign: 'center' }}>
                <p style={{ fontSize: '1.1rem', margin: '0 0 1.5rem 0', opacity: '0.9' }}>개인 프로필을 사용하려면 로그인이 필요합니다</p>
                <button 
